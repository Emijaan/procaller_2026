    ...
    <div className="flex-1 overflow-y-auto bg-[#F8FAFC] fade-in">
      <div className="max-w-[1400px] mx-auto px-6 py-6 space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <StatCard label="Online" value={stats?.online_agents ?? 0} />
          <StatCard label="Preview Auto" value={stats?.preview_agents ?? 0} />
          <StatCard label="Manual" value={stats?.manual_agents ?? 0} />
          <StatCard label="Break" value={stats?.break_agents ?? 0} />
        </div>
